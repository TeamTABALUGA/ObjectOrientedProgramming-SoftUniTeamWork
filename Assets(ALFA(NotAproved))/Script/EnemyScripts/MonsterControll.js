...
//Move Params
private var f_verticalSpeed : float = 5.0;
...
private var f_minAirTime : float = 0.0; // 0.15 sec.
...
public function Update() : void {
	...
	var f_hor : float = target.position.x;//Input.GetAxis("Horizontal");
	//Get Vertical move - move forward or backward
	var f_ver : float = target.position.z;//Input.GetAxis("Vertical");
